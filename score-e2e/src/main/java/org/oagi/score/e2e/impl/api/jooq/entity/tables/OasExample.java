...
public class OasExample extends TableImpl<OasExampleRecord> {
     ...
     * the example.
     */
    public final TableField<OasExampleRecord, String> SUMMARY = createField(DSL.name("summary"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "Short description for the example.");
     ...
     * representation.
     */
    public final TableField<OasExampleRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "Long description for the example. CommonMark syntax MAY be used for rich text representation.");
     ...
     * necessary.
     */
    public final TableField<OasExampleRecord, String> VALUE = createField(DSL.name("value"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "Embedded literal example. The value field and externalValue field are mutually exclusive. To represent examples of media types that cannot naturally represented in JSON or YAML, use a string value to contain the example, escaping where necessary.");
