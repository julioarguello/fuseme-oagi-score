...
public class OasServer extends TableImpl<OasServerRecord> {
     ...
     */
    public final TableField<OasServerRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "An optional string describing the host designated by the URL. CommonMark syntax MAY be used for rich text representation.");
     ...
     */
    public final TableField<OasServerRecord, String> VARIABLES = createField(DSL.name("variables"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "A map between a variable name and its value. The value is used for substitution in the server's URL template.");
