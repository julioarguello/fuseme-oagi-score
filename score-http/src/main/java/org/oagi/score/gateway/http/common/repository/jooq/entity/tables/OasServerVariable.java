...
public class OasServerVariable extends TableImpl<OasServerVariableRecord> {
     ...
     */
    public final TableField<OasServerVariableRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "An optional description for the server variable. CommonMark syntax MAY be used for rich text representation.");
     ...
     */
    public final TableField<OasServerVariableRecord, String> DEFAULT = createField(DSL.name("default"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "REQUIRED. The default value to use for substitution, which SHALL be sent if an alternate value is not supplied. Note this behavior is different than the Schema Object's treatment of default values, because in those cases parameter values are optional. If the enum is defined, the value SHOULD exist in the enum's values.");
     ...
     */
    public final TableField<OasServerVariableRecord, String> ENUM = createField(DSL.name("enum"), SQLDataType.CLOB(65535).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "An enumeration of string values to be used if the substitution options are from a limited set. The array SHOULD NOT be empty.");
